...
import com.asiah.quranapp.databinding.ActivityMainBinding
import com.asiah.quranapp.utils.PERMISSION_LOC_REQ_CODE
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSION_LOC_REQ_CODE) {
            if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                ...
                Toast.makeText(this, "Permission not found.", Toast.LENGTH_SHORT)
                    .show()
            }
        } else {
